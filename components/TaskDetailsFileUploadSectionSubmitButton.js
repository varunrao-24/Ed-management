...
const TaskDetailsFileUploadSectionSubmitButton = ({ style }) => {
...
TaskDetailsFileUploadSectionSubmitButton.defaultProps = {
  style: {}
};

export default TaskDetailsFileUploadSectionSubmitButton;
